...
interface Props {
  ...
  error?: string | null; showPassword: boolean;
  toggleShowPassword: () => void; placeholder?: string;
}

const PasswordInput = ({ id, name, label, value, onChange, error, showPassword, toggleShowPassword, placeholder }: Props) => {
  return (
    <div>
