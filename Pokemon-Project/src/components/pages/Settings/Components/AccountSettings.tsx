      ...
      {user ? (
        <>
          ...
          <div className="flex items-center gap-3 py-3 border-b border-gray-100 dark:border-gray-700">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-red-400 to-red-500 flex items-center justify-center text-white font-bold text-lg select-none">
        ...
        <div className="py-3 flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg bg-red-600 text-white text-sm font-medium hover:bg-red-700 transition-colors duration-200 cursor-pointer"
          >
            {t('account_sign_in')}
          </button>
        </div>
