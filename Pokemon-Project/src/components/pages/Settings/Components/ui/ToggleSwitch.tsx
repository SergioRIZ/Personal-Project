...
const ToggleSwitch = ({ isEnabled, onToggle }: Props) => (
  <button
    onClick={onToggle}
    className={`w-12 h-6 rounded-full p-1 transition-all duration-300 transform hover:scale-105 ${isEnabled ? 'bg-gradient-to-r from-red-400 to-red-500' : 'bg-gray-300 dark:bg-gray-600'}`}
  >
