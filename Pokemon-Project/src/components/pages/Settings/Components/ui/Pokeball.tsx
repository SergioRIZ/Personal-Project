...
const Pokeball = () => (
  <Link to="/pokedex" className="flex items-center justify-center w-full h-full">
    <div className="w-14 h-14 rounded-full bg-gradient-to-b from-red-600 to-red-800 border-4 border-slate-700 relative shadow-lg cursor-pointer transition-all duration-300 transform hover:scale-110 hover:rotate-12">
