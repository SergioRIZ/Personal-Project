        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden transform transition-all hover:scale-102">
            ...
            <div className="p-8">
                        ...
                        <div className="flex">
                            ...
                            <div className="ml-3">
                                <p className="text-sm font-medium">
                                    ¡Felicidades! Tu cuenta de entrenador ha sido creada.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-gray-800">Registro de Entrenador</h2>
                    ...
                    <div>
                        ...
                        <div className="relative rounded-md shadow-sm">
                            ...
                            <input
                                ...
                                className={`py-3 pl-10 w-full border ${errors.username ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'} rounded-xl shadow-sm`}
                    ...
                    <div>
                        ...
                        <div className="relative rounded-md shadow-sm">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`py-3 pl-10 w-full border ${errors.confirmPassword ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'} rounded-xl shadow-sm`}
                                placeholder="••••••••"
                            />
                        </div>
                ...
                <div className="mt-8">
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-3">
                        ...
                        <div>
                            <Link to="/team-builder" className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                <span className="sr-only">Regístrate con Twitter</span>
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
