  ...
  return (
      <div className="min-h-screen w-full flex flex-col items-center justify-center bg-blue-50 p-4">
          ...
          <div className="mb-6 text-center">
              <h1 className="text-4xl font-bold text-red-600 mb-2">Centro Pokémon</h1>
              <p className="text-gray-600">¡Regístrate para comenzar tu aventura!</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg border-4 border-yellow-400 space-y-6 relative overflow-hidden">
              ...
              <div className="relative bg-white bg-opacity-90 p-6 rounded-lg">
                  ...
                  {formSuccess && (
                      <div className="mb-4 p-3 bg-green-100 border border-green-400 text-green-700 rounded-lg">
                          ¡Felicidades! Tu cuenta de entrenador ha sido creada exitosamente.
                      </div>
                  )}
              ...
              <p className="relative z-10 text-center text-sm text-gray-600 mt-4 bg-white bg-opacity-90 py-2 rounded-lg">
                  ¿Ya tienes un PokéDex? <Link to="/login" className="text-red-600 hover:underline font-medium">¡Inicia tu aventura!</Link>
              </p>
          </form>
          
          {/* Footer separado debajo del formulario */}
          <div className="max-w-md w-full mt-4">
              <footer className="relative z-10 bg-white p-4 rounded-xl shadow-md border-4 border-yellow-400 flex justify-center items-center space-x-8">
                  <Link 
                      to="/" 
                      className="px-4 py-2 text-red-600 hover:text-white hover:bg-red-600 font-medium rounded-full border-2 border-red-600 transition-colors duration-300 flex items-center"
                  >
                  ...
                  <Link 
                      to="/login" 
                      className="px-4 py-2 bg-yellow-400 text-gray-800 hover:bg-yellow-500 font-medium rounded-full border-2 border-yellow-500 transition-colors duration-300 flex items-center"
                  >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
